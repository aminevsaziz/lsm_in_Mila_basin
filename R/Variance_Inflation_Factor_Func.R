...
Vif_Plot <- function(Input.Data,form,lim,xlab,ylab){
  ...
  gg <- gg + geom_point(stat='identity',shape=21,color="#a3c4dc",fill="#ef8a62", size=rel(7.5))  +
    geom_segment(aes(x = 0, y = Variables, xend = VIF, yend = Variables),size=0.0625, color = "#a3c4dc",linetype="longdash") +
